  ...
  sections: [
    {
      ...
      data: {
        ...
        customClasses: {
          section:
            "py-4 px-4 sm:py-6 sm:px-6 md:py-16 md:px-20 flex flex-col justify-center items-center",
          title: "mb-4 text-4xl sm:text-5xl font-bold text-center",
          subtitle: "mb-16 text-3xl sm:text-4xl text-center",
          button:
    ...
    },
    {
      ...
      data: {
        ...
        customClasses: {
          section:
            "py-4 px-4 sm:py-6 sm:px-6 md:py-12 md:px-20 flex items-center justify-center",
